...
import { PlusIcon, PencilIcon, DocumentTextIcon } from '@heroicons/react/24/outline';
        ...
        <div className="space-y-6">
            ...
            <div className="flex items-center justify-between">
                <div>
                    ...
                    <p className="text-gray-600 mt-2">Manage library resources and materials</p>
                </div>
                <Link
            ...
            {resources.length === 0 && (
                <div className="text-center py-12 bg-white rounded-xl border border-gray-200">
                    <p className="text-gray-500">No resources found. Upload your first resource to get started.</p>
                </div>
            )}
        </div>
    );
